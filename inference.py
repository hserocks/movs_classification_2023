...
def open_image(path_or_url):
    ...
    if path_or_url.startswith(('http://', 'https://')):
        ...
        return BytesIO(response.content) # Open the image directly from the response's bytes
    else:
        return path_or_url
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--path", type=str, help="image path", default = 'https://cdn.britannica.com/55/174255-050-526314B6/brown-Guernsey-cow.jpg')
