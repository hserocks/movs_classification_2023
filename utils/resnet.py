...
def prepare_data_resnet(images_folder_path):
    ...
    # Split the dataset
    train_dataset, test_dataset = random_split(dataset_norm,
    ...
    train_sample_weights = \
        [class_weights_tensor[label].item() for label in train_labels]
    ...
    dataloader = DataLoader(dataset_norm, batch_size=32,
...
def train_resnet(device, no_of_classes, train_loader, test_loader):
    ...
    resnet.fc = nn.Linear(resnet.fc.in_features,
