...
def download_rn_vit_features():
    ...
    for file in rn_vit_features:
        ...
        output = os.path.join(dl_folder, rn_vit_features_names[rn_vit_features.index(file)])
...
def download_SVM_XGB_models():
    ...
    for file in SVM_and_XGB_models:
        url = 'https://drive.google.com/uc?id=' + file
        output = os.path.join(dl_folder, SVM_and_XGB_models_names[SVM_and_XGB_models.index(file)])
        gdown.download(url, output, quiet=False)
...
def download_RESNET_VIT_weights():
    ...
    for file in resnet_and_vit_models:
        url = 'https://drive.google.com/uc?id=' + file
        output = os.path.join(dl_folder, resnet_and_vit_models_names[resnet_and_vit_models.index(file)])
        gdown.download(url, output, quiet=False)
